...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-x40vlai.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-x40vlai.containers.anotherwebservice.com/
...
```
git clone git@github.com:goomielol/container-x40vlai.git
cd container-x40vlai
```
...
```
docker attach container-x40vlai
```
